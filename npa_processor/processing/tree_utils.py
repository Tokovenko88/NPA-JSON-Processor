...
from npa_processor.processing.ai_utils import ask_ollama
...
def find_target_element_via_ai(change_data, original_data, log_callback, model, extra_options, stop_event=None, doc_type='law'):
    ...
    answer = ask_ollama(prompt, model, log_callback, extra_options, stop_event, change_info="")
    if answer is None:
        return None
    try:
